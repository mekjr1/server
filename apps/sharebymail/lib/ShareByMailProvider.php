...
class ShareByMailProvider implements IShareProvider {
	...
	protected function addShareToDB($itemSource, $itemType, $shareWith, $sharedBy, $uidOwner, $permissions, $token, $password, $sendPasswordByTalk) {
		...
		$qb->insert('share')
			...
			->setValue('password_by_talk', $qb->createNamedParameter($sendPasswordByTalk, IQueryBuilder::PARAM_INT))
	...
	public function update(IShare $share, $plainTextPassword = null) {
		...
		$qb->update('share')
			...
			->set('password_by_talk', $qb->createNamedParameter($share->getSendPasswordByTalk(), IQueryBuilder::PARAM_INT))
